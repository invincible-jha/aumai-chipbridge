# Contributing to AumAI Chipbridge
...
### Setup
```bash
git clone https://github.com/aumai/aumai-chipbridge.git
cd aumai-chipbridge
python -m venv .venv
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-chipbridge/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-chipbridge/discussions)
